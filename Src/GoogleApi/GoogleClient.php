...
namespace ATL15\GoogleAnalyticsBundle\Src\GoogleApi;

use ATL15\GoogleAnalyticsBundle\Src\GoogleApi\Auth;
use ATL15\GoogleAnalyticsBundle\Src\GoogleApi\Auth\OAuth2;
use ATL15\GoogleAnalyticsBundle\Src\GoogleApi\IO;
use ATL15\GoogleAnalyticsBundle\Src\GoogleApi\IO\CurlIO;
use ATL15\GoogleAnalyticsBundle\Src\GoogleApi\Cache;
use ATL15\GoogleAnalyticsBundle\Src\GoogleApi\Cache\FileCache;
use ATL15\GoogleAnalyticsBundle\Src\GoogleApi;
...
class GoogleClient
{
    ...
    public function addService($service, $version = false)
    {
        ...
        if ($this->authenticated) {
            throw new Google_AuthException('Cant add services after having authenticated');
        }
