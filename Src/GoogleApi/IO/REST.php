 ...
 */
namespace ATL15\GoogleAnalyticsBundle\Src\GoogleApi\IO;
use ATL15\GoogleAnalyticsBundle\Src\GoogleApi\GoogleClient;
use ATL15\GoogleAnalyticsBundle\Src\GoogleApi\Google_ServiceException;
...
class REST
{
    ...
    {
        $httpRequest = GoogleClient::$io->makeRequest($req);
