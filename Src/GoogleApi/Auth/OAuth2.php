...
namespace ATL15\GoogleAnalyticsBundle\Src\GoogleApi\Auth;

use ATL15\GoogleAnalyticsBundle\Src\GoogleApi\Google_AuthException;
use ATL15\GoogleAnalyticsBundle\Src\GoogleApi\IO\HttpRequest;
...
class OAuth2 extends Auth
{
    ...
    public function authenticate($service, $code = null)
    {
        ...
        if ($code) {
            ...
            $request = GoogleClient::$io->makeRequest(new HttpRequest(self::OAUTH2_TOKEN_URI, 'POST', array(), array(
                'code' => $code,
    ...
    private function refreshTokenRequest($params) {
        ...
        $request = GoogleClient::$io->makeRequest($http);
    ...
    public function revokeToken($token = null) {
        ...
        $response = GoogleClient::$io->makeRequest($request);
    ...
    private function getFederatedSignOnCerts() {
        ...
        $request = GoogleClient::$io->makeRequest(new HttpRequest(
