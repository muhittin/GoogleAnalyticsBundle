 ...
 */
namespace ATL15\GoogleAnalyticsBundle\Src\GoogleApi\Service;

use ATL15\GoogleAnalyticsBundle\Src\GoogleApi\Service\MediaFileUpload;
use ATL15\GoogleAnalyticsBundle\Src\GoogleApi\IO\HttpRequest;
use ATL15\GoogleAnalyticsBundle\Src\GoogleApi\IO\REST;
...
class ServiceResource {
  ...
  public function __call($name, $arguments) {
    ...
    $httpRequest = GoogleClient::$auth->sign($httpRequest);
    if (GoogleClient::$useBatch) {
      return $httpRequest;
    }
